...
const Game: React.FC<GameProps> = ({ setUserChoice }: GameProps) => {
    ...
    return (
        <Wrapper>
            <Link to="/results">
                <Button
                    left bottom onClick={setChoiceOnClick} value="rock" aria-label="button selects rock">
            ...
            <Link to="/results">
                <Button
                    blue bottomL onClick={setChoiceOnClick} value="paper" aria-label="button selects paper">

...
const Game: React.FC<GameProps> = ({ setUserChoice, setCompChoice }: GameProps) => {
    ...
    return (
        <Wrapper>
            <Link to="/results">
                <Button data-id="rock" left bottom onClick={setChoiceOnClick} >
            ...
            <Link to="/results">
                <Button data-id="paper" blue bottomL onClick={setChoiceOnClick} >
            ...
            <Link to="/results">
                <Button data-id="scissors" yellow bottom leftL onClick={setChoiceOnClick} >

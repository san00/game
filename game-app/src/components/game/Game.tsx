...
const Game: React.FC<GameProps> = ({ setUserChoice, setCompChoice }: GameProps) => {
    ...
    return (
        <Wrapper>
            <Link to="/results">
                <Button data-id="rock" left bottom onClick={setChoiceOnClick} aria-label="button selects rock">
            ...
            <Link to="/results">
                <Button data-id="paper" blue bottomL onClick={setChoiceOnClick} aria-label="button selects paper" >
            ...
            <Link to="/results">
                <Button data-id="scissors" yellow bottom leftL onClick={setChoiceOnClick} aria-label="button selects scissors">
